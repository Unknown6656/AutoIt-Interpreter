#cs
   ...
   THE INTERPERETER OUTPUT SHOULD BE:
	  ...
	  BINARYTOSTRING(True) = 
	  BINARYTOSTRING(False) = BINARYTOSTRING() = BINARYTOSTRING(Default) = ÿÿÿÿ
	  BINARYTOSTRING(65280) = BINARYTOSTRING(255) = ÿBINARYTOSTRING(-81985529216486896) = 2Tv˜ºÜþ
	  BINARYTOSTRING(0xAAFFBB00) = ªÿ»BINARYTOSTRING(0xaaffbb00) = ªÿ»BINARYTOSTRING(0xfedcba9876543210) = þÜº˜vT2
