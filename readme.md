...
## License
The code is licensed under the Giant Penis License (GPL), which is a more restrictive version of the MIT License. [Click here](/Unknown6656/AutoIt-Interpreter/blob/daddy/LICENSE.md) for more information.
